...
$statement = $conn->prepare("SELECT C.id as id, C.content as content, C.created_at as created_at, U.nickname as nickname FROM comments as C left join users as U on C.user_id = U.username ORDER BY C.id DESC");
